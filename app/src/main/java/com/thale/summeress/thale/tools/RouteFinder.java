...
import com.thale.summeress.thale.model.Route;
...
public class RouteFinder {
    private static String TAG = "RouteFinder";
    public static List<Segment> allSegment;

    public static void init(Context context){

        allSegment = new LinkedList<>();
        InputStream is = context.getResources().openRawResource(R.raw.route);
        String line;
    ...
    public static List<Segment> findRoute(Context context, Point sPoint, Point ePoint){
        init(context);
        List<Segment> rList = allSegment;
        if (rList.isEmpty()){
            return null;
        }
    ...
    public static List<Segment> findRouteSameFloor(List<Segment> rList, Point sPoint, Point ePoint){
        sPoint = new Point(sPoint);
        ePoint = new Point(ePoint);
